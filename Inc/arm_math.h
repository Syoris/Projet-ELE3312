 ...
 */
#if   defined ( __CC_ARM )
  #define __SIMD32_TYPE int __packed
#elif defined ( __ARMCC_VERSION ) && ( __ARMCC_VERSION >= 6010050 )
  ...
  #define __SIMD32_TYPE int
#elif defined ( __TASKING__ )
  #define __SIMD32_TYPE __un(aligned) int
#elif defined(_MSC_VER )
  #define __SIMD32_TYPE int
#else
  #error Unknown compiler
...
*/
  ...
  __STATIC_FORCEINLINE int __SSAT(int val, uint32_t sat)
  {
    if ((sat >= 1U) && (sat <= 32U))
    {
  ...
  __STATIC_FORCEINLINE uint32_t __USAT(int val, uint32_t sat)
  {
    if (sat <= 31U)
    {
  ...
  #define __PACKq7(v0,v1,v2,v3) ( (((int)(v0) <<  0) & (int)0x000000FF) | \
                                  (((int)(v1) <<  8) & (int)0x0000FF00) | \
                                  (((int)(v2) << 16) & (int)0x00FF0000) | \
                                  (((int)(v3) << 24) & (int)0xFF000000)  )
#else
  #define __PACKq7(v0,v1,v2,v3) ( (((int)(v3) <<  0) & (int)0x000000FF) | \
                                  (((int)(v2) <<  8) & (int)0x0000FF00) | \
                                  (((int)(v1) << 16) & (int)0x00FF0000) | \
                                  (((int)(v0) << 24) & (int)0xFF000000)  )
#endif
 ...
 */
  ...
  uint32_t y)
  {
    ...
    r = __SSAT(((((q31_t)x << 24) >> 24) + (((q31_t)y << 24) >> 24)), 8) & (int)0x000000FF;
    s = __SSAT(((((q31_t)x << 16) >> 24) + (((q31_t)y << 16) >> 24)), 8) & (int)0x000000FF;
    t = __SSAT(((((q31_t)x <<  8) >> 24) + (((q31_t)y <<  8) >> 24)), 8) & (int)0x000000FF;
    u = __SSAT(((((q31_t)x      ) >> 24) + (((q31_t)y      ) >> 24)), 8) & (int)0x000000FF;
...
/*  q31_t r,     s;  without initialisation 'arm_offset_q15 test' fails  but 'intrinsic' tests pass! for armCC */
    ...
    r = __SSAT(((((q31_t)x << 16) >> 16) + (((q31_t)y << 16) >> 16)), 16) & (int)0x0000FFFF;
    s = __SSAT(((((q31_t)x      ) >> 16) + (((q31_t)y      ) >> 16)), 16) & (int)0x0000FFFF;
  ...
  uint32_t y)
  {
    ...
    r = (((((q31_t)x << 16) >> 16) + (((q31_t)y << 16) >> 16)) >> 1) & (int)0x0000FFFF;
    s = (((((q31_t)x      ) >> 16) + (((q31_t)y      ) >> 16)) >> 1) & (int)0x0000FFFF;
  ...
  uint32_t y)
  {
    ...
    r = __SSAT(((((q31_t)x << 16) >> 16) - (((q31_t)y      ) >> 16)), 16) & (int)0x0000FFFF;
    s = __SSAT(((((q31_t)x      ) >> 16) + (((q31_t)y << 16) >> 16)), 16) & (int)0x0000FFFF;
  ...
  uint32_t y)
  {
    ...
    r = (((((q31_t)x << 16) >> 16) - (((q31_t)y      ) >> 16)) >> 1) & (int)0x0000FFFF;
    s = (((((q31_t)x      ) >> 16) + (((q31_t)y << 16) >> 16)) >> 1) & (int)0x0000FFFF;
   ...
   */
  __STATIC_FORCEINLINE int __QADD(
  int x,
  int y)
  {
    return ((int)(clip_q63_to_q31((q63_t)x + (q31_t)y)));
  }
   ...
   */
  __STATIC_FORCEINLINE int __QSUB(
  int x,
  int y)
  {
    return ((int)(clip_q63_to_q31((q63_t)x - (q31_t)y)));
...
/*  return (sum + ((q15_t) (x >> 16) * (q15_t) y)) + ((q15_t) x * (q15_t) (y >> 16)); */
   ...
   */
//  __STATIC_FORCEINLINE int __SMMLA(
//  int x,
//  int y,
//  int sum)
//  {
//    return (sum + (int) (((int64_t) x * y) >> 32));
//  }
 ...
 /**
  ...
  typedef struct
  {
    ...
    const float32_t *pCoeffs;           /**< points to the coefficient array. The array is of length numTaps.*/
          ...
          int *pTapDelay;           /**< points to the array of delay values.  The array is of length numTaps. */
...
__STATIC_FORCEINLINE void arm_inv_park_q31(
  ...
  uint32_t nValues)
  {
    ...
    int index;                               /* Index to read nearest output values */
 ...
 */
  ...
  */
  ...
  q31_t Y)
  {
    ...
    int rI, cI;                              /* Row and column indices */
    ...
    /* Read two nearest output values from the index */
    x1 = pYData[(rI) + (int)nCols * (cI)    ];
    x2 = pYData[(rI) + (int)nCols * (cI) + 1];
    ...
    /* Read two nearest output values from the index */
    y1 = pYData[(rI) + (int)nCols * (cI + 1)    ];
    y2 = pYData[(rI) + (int)nCols * (cI + 1) + 1];
